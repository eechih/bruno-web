...
import { API, Amplify, Auth, Cache } from 'aws-amplify'
...
import { ListProductsQuery, Product } from '@/graphql/API'
...
export default function Page() {
  ...
  async function listProducts(props?: {
    ...
    const key = 'products'
    let products = Cache.getItem(key)
    ...
    try {
      if (!products) {
        ...
        console.log('res', res)
        products = res.data?.listProducts as Product[]
